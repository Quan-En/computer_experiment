...
# from ..utils.resnet_internally_replaced_utils import load_state_dict_from_url # use torch.hub (move down)
from torch.hub import load_state_dict_from_url


# from ..utils.resnet_utils import _log_api_usage_once # move down
