...
def main():
    ...
    pure_z1y1 = (test_functions.test_f(all_x) + 1.37) / 51.05
    pure_z1y2 = (test_functions.test_f(all_x[:,::-1]) + 1.37) / 51.05
    pure_z2y1 = (test_functions.Levy_f13(all_x) - 0.16) / 90.90
    pure_z2y2 = (test_functions.Levy_f13(-all_x) - 0.16) / 90.90
    ...
    save_folder_name = "../experiment_result/numerical/c2_" + ModelName + "_ss" + str(SampleSize) + "_gs" + str(GridSize) + "_ns" + str(NoiseSigma).replace(".", "-")
